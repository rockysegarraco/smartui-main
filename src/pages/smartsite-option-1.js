...
import SmartSiteTabScrollDelivery from "@/components/SmartSiteTabScrollDelivery";
import SmartSiteTabScrollPickup from "@/components/SmartSiteTabScrollPickup";
import SmartSiteTabScrollShipping from "@/components/SmartSiteTabScrollShipping";
...
export default function Page() {
  ...
  return (
    <>
      <NavSmartSite />
      <div className="p-8">
        <div className="m-auto max-w-[490px] rounded-md mb-5 text-[9px] uppercase text-slate-500">
          SmartSite Option 1
        </div>
        <div className="m-auto max-w-[490px] bg-white shadow-sm rounded-md">
          {/* INPUT */}
          <div className="p-4">
            <Select />
          </div>
          ...
          {/* Delivery Tab */}
          {tab === "Delivery" && <SmartSiteTabScrollDelivery />}

          {/* Pickup Tab */}
          {tab === "Pickup" && <SmartSiteTabScrollPickup />}

          {/* Shipping Tab */}
          {tab === "Shipping" && <SmartSiteTabScrollShipping />}

          {/* SHARE BTN */}
          <div className="flex items-center border-t">
            <div className="flex-auto text-center p-4 border-r bg-slate-50 hover:bg-slate-100 cursor-pointer">
              <div className="flex items-center justify-center">
                <div>
                  <svg className="pr-2 h-6" viewBox="0 0 50 50" fill="#3b82f6">
            ...
            <div className="flex-auto text-center p-4 bg-slate-50 hover:bg-red-100 cursor-pointer">
