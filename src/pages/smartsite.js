    ...
    <>
      <div className="flex">
        <div className="flex flex-col justify-center items-center pt-0 lg:pt-8 lg:p-8">
          <div className="m-auto max-w-md bg-white shadow-sm">
            {/* HERO */}
            <img
        ...
        <div className="flex flex-col justify-center items-center pt-0 lg:pt-8 lg:p-8">
          <div className="m-auto max-w-xl bg-white shadow-sm">
            {/* TEXT */}
            <div className="pt-0 pb-4">
              <div className="text-center text-2xl text-slate-900 py-2 px-4">
                <div>
                  <select
                    id="location"
                    name="location"
