...
import ScrollButtonOnly from "@/components/ScrollButtonOnly";
...
export default function Page() {
  ...
  return (
    <>
      <NavSmartSite />
      <div className="p-8">
        <div className="m-auto max-w-[387px] rounded-md mb-5 text-[9px] uppercase text-slate-500">
          SmartSite Option 2
        </div>
        <div className="m-auto max-w-[387px] bg-white shadow-sm rounded-md">
          {/* INPUT */}
          <div className="pt-4 pb-2 px-4">
            <Select />
          </div>
          <div className="rounded-lg mt-2 mb-0">
            <div className="bg-slate-50 px-4 py-2 text-blue-700">
              <div className="text-[14px] text-blue-700 font-medium uppercase">
                Delivery
              </div>
            </div>
            <div>
