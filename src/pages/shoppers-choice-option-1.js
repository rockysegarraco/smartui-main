    ...
    <>
      <div>
        ...
        <div className="flex flex-col justify-center items-center pt-0 lg:pt-8 lg:p-8">
          <div className="mx-auto max-w-[390px] bg-white shadow-sm">
            {/* HERO */}
            <img
            ...
            <div className="pt-0 pb-4">
              <div className="text-center text-2xl text-slate-900 pb-2">
                Get ready to wrap things up!
              </div>
              <div className="text-center text-base text-slate-900 pb-2">
            ...
            {/* Delivery Tab */}
            {tab === "Deliver it" && <DeliveryTab />}

            {/* Pickup Tab */}
            {tab === "In Store" && <PickupTab />}
