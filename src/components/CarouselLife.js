...
const retailers = [
  {
    ...
    logo: "/img/grapefruit.png",
  },
  {
    id: 2,
    name: "The quick brown fox jumps over the lazy dog",
    price: "Lime & Mint",
    logo: "/img/can-lime.png",
  },
  {
    id: 3,
    name: "The quick brown fox jumps over the lazy dog",
    price: "Sparkling Water Peach",
    logo: "/img/can-peach.png",
  },
  {
    id: 4,
    name: "The quick brown fox jumps over the lazy dog",
    price: "Strawberry Lemonade",
    logo: "/img/can-strawberry.png",
  },
  {
    id: 5,
    name: "The quick brown fox jumps over the lazy dog",
                  ...
                  <div
                    className={`bg-white border ${
                      activeCardId === retailer.id
                        ? "border-[#4363F9] border-2 shadow-md"
                        : "border-gray-200"
                    } rounded-lg p-1 sm:p-2 flex flex-col items-center h-full transition-all cursor-pointer hover:border-2 hover:border-[#4363F9] hover:shadow-md`}
                    onClick={() => {
