...
import DarkButtonMap from "@/components/Buttons/DarkButtonMap";
            ...
            <div className="flex flex-row gap-x-2 animate-delay-[.7s] animate-fade animate-once">
              <div className="lg:basis-1/2 basis-1/2 text-center py-2 px-4 bg-[#006241] rounded-full uppercase text-sm cursor-pointer">
                <div className="flex items-center justify-center">
                  <div>
                    <svg className="h-6" viewBox="0 0 50 50" fill="#FFFFFF">
              ...
              <div className="lg:basis-1/2 basis-1/2 py-2 px-4 bg-[#E60023] rounded-full uppercase text-sm cursor-pointer">
                <div className="flex items-center justify-center">
                  <div>
                    <svg
                      className="pr-0 h-6"
