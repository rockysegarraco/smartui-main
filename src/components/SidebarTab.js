                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">
                      <div className="flex flex-row items-center gap-x-4 border p-4">
                        <div>
                          <img
                            className="w-[125px]"
                            src="https://cdn.flippenterprise.net/page_pdf_images/18088538/5d243098-e80a-11ee-9e56-0e7faade0358/x_large"
                            alt=""
                          />
                        </div>
                      ...
                      <div className="flex flex-row items-center gap-x-4 border p-4">
                        <div>
                          <img
                            className="w-[125px]"
                            src="https://cdn.flippenterprise.net/page_pdf_images/18088538/665f5a98-e80a-11ee-9e56-0e7faade0358/x_large"
                            alt=""
                          />
                        </div>
                        <div className="grow text-sm">
                      ...
                      <div className="mt-0">
                        <div className="flex items-center justify-between p-4 bg-slate-100 mb-2 mt-1 rounded-sm">
                          ...
                          <div className="font-bold">$5.48</div>
                        </div>
